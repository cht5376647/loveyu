...
function theme_widget_goods_shopmax_list(&$setting,&$render){
    ...
    $objPoint =  $_dependApp->model('comment_goods_point');
    foreach ($products as $product) {
            
            $_return['goodsRows'][$product['goods_id']]['products'][] = $product;
			$_return['goodsRows'][$product['goods_id']]['total_point_nums']= $objPoint->get_point_nums($product['goods_id']);
